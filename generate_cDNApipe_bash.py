...
@check_file_or_run('ccs_reads.53Aseen_trimmed_changeid.fa.primer_info.txt.summary')
...
@check_file_or_run('ccs_reads.53Aseen_trimmed_changeid.fa.non_chimera.fa')    
...
@check_file_or_run('ccs_reads.53Aseen_trimmed_changeid.fa.non_chimera.fa.blasr.sam')        
...
@check_file_or_run('ccs_reads.53Aseen_trimmed_changeid.fa.non_chimera.fa.gff.log')
